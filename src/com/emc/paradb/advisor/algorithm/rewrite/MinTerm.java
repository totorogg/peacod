...
public class MinTerm
{
	...
	//[tag xiaoyan]
	public double prop = 1.0; // for split
	...
	public MinTerm(MinTerm oldMinTerm)
	{
		terms = new ArrayList<Predicate>();
		...
		this.node = oldMinTerm.node;
		this.pos = oldMinTerm.pos;
		this.size = oldMinTerm.size;
		this.offset = oldMinTerm.offset;
		this.length = oldMinTerm.length;
		this.edgeCnt = oldMinTerm.edgeCnt;
		this.accessCnt = oldMinTerm.accessCnt;
